...
export const copy = {
  en: {
    ...
    noCountryCodes: "No country codes found.",
    email: "Email",
    date: "Date",
    time: "Time",
    partySize: "Guests",
    ...
    mealPeriodFull: "No availability for this meal period.",
    checkingAvailability: "Checking availability...",
    availabilityCheckError: "Availability could not be checked. Please try again.",
  ...
  pt: {
    ...
    countryCodeSearch: "Pesquisar país ou indicativo",
    noCountryCodes: "Nenhum indicativo encontrado.",
    email: "Email",
    date: "Data",
    time: "Hora",
    partySize: "Pessoas",
    ...
    mealPeriodFull: "Sem disponibilidade para este período de refeição.",
    checkingAvailability: "A verificar disponibilidade...",
    availabilityCheckError: "Não foi possível verificar a disponibilidade. Tente novamente.",
  ...
  zh: {
    ...
    phone: "电话",
    countryCode: "国家/地区代码",
    countryCodeSearch: "搜索国家/地区或区号",
    noCountryCodes: "未找到国家/地区代码。",
    email: "邮箱",
    date: "日期",
    time: "时间",
    partySize: "人数",
    ...
    nextWeek: "后 7 天",
    noTimes: "该日期暂无可预订时间。",
    mealPeriodFull: "该用餐时段暂无可用位置。",
    checkingAvailability: "正在查询可订情况...",
    availabilityCheckError: "无法查询可订情况，请重试。",
